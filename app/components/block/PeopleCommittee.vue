			...
			<UMarquee 
				...
				:ui="{
					...
					<PersonProfileCard
						...
						image-class="h-40"
						:ui="{ badge: 'text-xs mx-auto', name: 'font-heading', body: 'mx-auto', header: 'mx-auto h-10 flex flex-col justify-center' }"
					/>
			</UMarquee>
			...
			<div
				...
				<PersonProfileCard
					...
					:ui="{
						...
						badgeWrapper: 'text-center font-heading whitespace-normal h-15 align-items-center flex flex-row',
