...
interface ChargeTableAccomodationProps {
	data: 'table' | 'cards'
}


const props = defineProps<ChargeTableAccomodationProps>();
const type = props.data;
const tabs = ref();
const { data } = await useAsyncData <Congress>('accomodationcharges', async() => {
...
const charges = data.value?.accomodation_charges || [];
